...
import org.gooru.profilebaseline.infra.services.algebra.competency.mappers.CompetencyMapper;
...
interface LearnerProfileProviderDao {
  ...
  @SqlQuery("SELECT tx_subject_code, tx_domain_code, tx_comp_code, tx_comp_seq FROM domain_competency_matrix "
